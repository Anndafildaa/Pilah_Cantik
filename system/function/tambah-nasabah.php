...
if(isset($_POST['simpan'])){
      ...
      mysqli_query($conn, "INSERT INTO nasabah (id, nama, alamat, no_telepon, email, saldo, sampah) VALUES ('$id','$nama','$alamat','$no_telepon','$email','$saldo','$sampah')");
      mysqli_error($conn);
...
<body>
	   ...
	   <form id="daftar_user" action="" method="post" onsubmit="return cek_data()">
         ...
         <div class="form-group">
           ...
           <input type="text" name="nama" placeholder="Masukan password nasabah" />
         </div>
