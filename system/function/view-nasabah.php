...
<body>
	   ...
	   <div class="form-group">
            ...
            <input type="text" style="cursor: not-allowed;" disabled="disabled" value="<?php echo @$_SESSION['id']; ?>" />
         </div>
         <div class="form-group">
          <label class="">Nama Nasabah</label>
          <input type="text" style="cursor: not-allowed;" disabled="disabled" value="<?php echo @$_SESSION['nama']; ?>"/>
         </div>
         <div class="form-group">
          <label class="">Password</label>
          <input type="text" style="cursor: not-allowed;" disabled="disabled" value="<?php echo @$_SESSION['password']; ?>"/>
         </div>
         <div class="form-group">
         ...
         <div class="form-group">
          ...
          <input type="text" style="cursor: not-allowed;" disabled="disabled" value="<?php echo @$_SESSION['no_telepon']; ?>"/>
         </div>
         <div class="form-group">
          <label class="">E-mail</label>
          <input type="text" style="cursor: not-allowed;" disabled="disabled" value="<?php echo @$_SESSION['email']; ?>"/>
         </div>
         <div class="form-group">
